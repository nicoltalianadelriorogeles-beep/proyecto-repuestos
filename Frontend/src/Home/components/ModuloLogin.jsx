function Login({ formulario, manejarCambio, manejarSubmit, modoRecuperacion, setModoRecuperacion, correoRecuperacion, setCorreoRecuperacion, solicitarRecuperacion, irRegistro }) {
