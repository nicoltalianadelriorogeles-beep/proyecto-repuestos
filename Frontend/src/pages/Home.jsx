...
function Home({
  ...
  return (
    <main className={`home-view home-view-${seccion}`}>
      ...
      {/* Acceso visual: formularios de muestra sin lógica. */}
      <section id="acceso" className="py-5 home-access-section">
        <div className="container">
          <div className="section-heading">
            <span className="cliente-label">TU CUENTA</span>
            <h2 className="fw-bold text-primary mt-2">Compra de forma sencilla</h2>
            <p className="text-secondary">Ingresa o crea tu cuenta para continuar.</p>
          </div>

          <div className="home-auth-grid">
            <div className="home-auth-card home-auth-login">
              <div className="home-auth-icon"><i className="fa-solid fa-right-to-bracket"></i></div>
              <span className="cliente-label">BIENVENIDO</span>
              <h3>Iniciar sesión</h3>
              <p>Consulta tus pedidos y encuentra tus repuestos favoritos.</p>
            ...
            <div className="home-auth-card home-auth-register">
              <div className="home-auth-icon"><i className="fa-solid fa-user-plus"></i></div>
              <span className="cliente-label">NUEVO CLIENTE</span>
              <h3>Crear una cuenta</h3>
              <p>Regístrate para recibir atención personalizada y comprar fácilmente.</p>
              <form className="home-auth-form">
